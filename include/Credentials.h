...
WM_Configuration defineDefaultConfig() {
  WM_Configuration config;
  
  config.wifi_ssid = "yotspot";
  config.wifi_pw = "swordfish3";
  config.board_name = "TOUCH_LAMP_DEFAULT";
  config.assigned_color = "#F8F358";

  return config;
}

WM_Configuration defaultConfig = defineDefaultConfig();
